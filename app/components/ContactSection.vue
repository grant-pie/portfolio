    ...
    <div class="container">
      ...
      <div class="contact-content">
        <p class="contact-description">
          I'm currently open to junior front-end developer opportunities. Whether you have a role in mind,
          a question, or just want to say hi — my inbox is open.
        </p>
        <a href="mailto:grant@grantpieterse.com" class="contact-email">
          grant@grantpieterse.com
        </a>
        <div class="contact-links">
          <a href="https://github.com/grant-pie" target="_blank" rel="noopener" class="contact-link" aria-label="GitHub">
          ...
          <a href="https://www.linkedin.com/in/grant-pieterse-58727a182/" target="_blank" rel="noopener" class="contact-link" aria-label="LinkedIn">
